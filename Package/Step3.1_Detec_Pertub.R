...
# Set working directory  
  ...
  #-------------------------------------------------------------------------------
  # Make empty tables for the results of the loop
  # Because before running the loop we need a data frame to store results for all animals 
  #-------------------------------------------------------------------------------
  
  # Data frame about information of Spline function of the differences between ITC and CFI and their derivative
  fn.difp1 <- data.frame()
